This is  my first task as intern at Apex Planet 
...
<head>
    ...
    <title>Raghvendra Pratap Singh | First Webpage</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="card">
            <h2>About Me</h2>
            <p>
                Hi! I'm <strong>Raghvendra Pratap Singh</strong>, an aspiring web developer currently learning 
    ...
    <script>
        function showMessage() {
            alert("Hello! Welcome to Raghvendra's webpage 🎉");
        }
    </script>
